...
Selection pressures can only act upon the phenotypic variation that a given template can produce, which in turn is a function of how integrated its component structures are. Elucidating form-function relationships is therefore critical to drawing conclusions about the potential roles of selection and constraints in producing patterns of phenotypic variation. Our evolutionary regressions suggest that morphological traits (melanosome diameter and spacing) are, at least in part, functionally independent (i.e. contributing to separate color attributes). The near-zero covariation between hue and brightness suggests that functional complexity eliminates tradeoffs between these optical traits {e.g., see Holzman 2011, Wainwright 2007}. By contrast, hue and saturation have evolved in a correlated fashion and at similar rates, and that this integration arises because of their common morphological basis (melanosome diameter). 

Our study shows that the modularity of the form-function mapping in the two-dimensional photonic crystal found in duck specula controls the potenial to respond to selection (i.e. evolvability) of these ornamental traits. These traits have been suggested to be involved in mate choice in some species such as the northern pintails _Anas acuta_, where females were shown to prefer males with more iridescence in their wings {Sorenson & Derrickson 1994}. Additionally, the quality of wing patches determined pairing success in mallards (_Anas platyrhynchos_), but only in the fall {Omland 1996}. Iridescent colors have also been suggested be condition-dependent in some species of ducks {Legagneux et al. 2010}, thus highlighting their potential as honest visual signals. Iridescent specula may also function as species recognition signals (mediating/reducing introgression?/). Despite rampant dichromatism in overall body plumage among Anatidae {Omland 1997, Figuerola & Green 2000}, many species have monochromatic wing patches {REF}, one of the predictions of the species recognition hypothesis (character displacement? reinforcement?). Whether and how these visual signals play a role in mate choice, intrasexual competition or species recognition remains a fertile area for future research. Our study shows that, whatever the selective forces acting on these colors are, the intricacies of the structure underlying these signals results in both the integration and modularity of color properties, thus dictating how these color traits can evolve to explore the available gamut that this labile template provides.
...
We found that brightness evolves faster than hue, and that this pattern emerges because the spacing between melanosomes evolves faster than the diameter of melanosomes itself. Moreover, this pattern is likely due to differences in their evolutionary variances rather than in patterns of selection or constraint (Fig. S6). This suggests that structural aspects of the photonic crystal - the arrangement of its components - is likely to diverge faster than the morphological "building blocks" of the structure. The question of why structural traits diverge faster than morphological traits remains unanswered (e.g., see {King & Jukes 1969}). Melanosome synthesis and deposition are complex processes involving a number of genes (reviewed in Marks 2001), and melanosome spacing is likely sensitive to additional nongenetic factors (temperature, rate of melanosome deposition, keratin polymerization rates {Maia 2011, Prum?}) that could increase phenotypic variation. Complex developmental processes may evolve quickly due to more evolutionary degrees of freedom (steps in the process, genes involved in regulatory processes, etc.) {Wund 2012}. Melanosomes are themselves structural organelles, and therefore accumulating mutations in their ontogenetic pathways may require longer evolutionary time and be more averse to mutations of medium or large effect {REF?}. Even though at larger scales, melanosome morphology shows considerable morphological variation {REF NEW DINO PPR}, melanosome morphology is usually highly conserved among closely-related species {REF Greenewalt, Durrer, grackles and allies paper}, with very few exceptions {Maia etal}. The melanosomes responsible for the two-dimensional structure found in ducks are among the thinnest and longest found in birds {Eliason Shawkey}, and this aspect of their morphology might actually be critical to allow such pattern to be formed (which, in turn, might explain its rarity among birds given the stability of this structural organization, REF). Therefore, the limitations on melanosome morphology necessary to produce a functional two-dimensional hexagonal structure may further limit the range of functional morphologies, and thus the rate of evolution, of melanosome shape.

<!-- RM: The following can be shortened and added to the argument above. I think you wrote and explained it better, so I'll leave it to you to add it :)  I'd also remove the engineering bit, not particularly relevant given the rest of the context of the manuscript.
